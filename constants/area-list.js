    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { value: 340703, label: '狮子山区' },
          { value: 340702, label: '铜官山区' },
          { value: 340721, label: '铜陵县' }
        ]
      },
      {
        value: 340200,
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: '两江新区',
        children: [
          { value: 500302, label: '保税港区' },
          { value: 500301, label: '北部新区' },
          { value: 500303, label: '工业园区' }
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: '嘉峪关市',
        children: [
          { value: 620202, label: '长城区' },
          { value: 620203, label: '镜铁区' },
          { value: 620201, label: '雄关区' }
        ]
      },
      {
        value: 620300,
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: '东莞市',
        children: [
          { value: 441932, label: '长安镇' },
          { value: 441914, label: '常平镇' },
          { value: 441907, label: '茶山镇' },
          { value: 441916, label: '大朗镇' },
          { value: 441921, label: '大岭山镇' },
          { value: 441927, label: '道滘镇' },
          { value: 441913, label: '东坑镇' },
          { value: 441931, label: '凤岗镇' },
          { value: 441919, label: '高埗镇' },
          { value: 441901, label: '莞城区' },
          { value: 441910, label: '横沥镇' },
          { value: 441924, label: '洪梅镇' },
          { value: 441930, label: '厚街镇' },
          { value: 441923, label: '黄江镇' },
          { value: 441929, label: '虎门镇' },
          { value: 441915, label: '寮步镇' },
          { value: 441917, label: '麻涌镇' },
          { value: 441902, label: '南城区' },
          { value: 441911, label: '桥头镇' },
          { value: 441925, label: '清溪镇' },
          { value: 441909, label: '企石镇' },
          { value: 441926, label: '沙田镇' },
          { value: 441905, label: '石碣镇' },
          { value: 441906, label: '石龙镇' },
          { value: 441908, label: '石排镇' },
          { value: 441928, label: '塘厦镇' },
          { value: 441922, label: '望牛墩镇' },
          { value: 441904, label: '万江区' },
          { value: 441912, label: '谢岗镇' },
          { value: 441920, label: '樟木头镇' },
          { value: 441918, label: '中堂镇' }
        ]
      },
      {
        value: 440600,
      ...
      },
      {
        ...
        children: [
          ...
          { value: 440311, label: '大鹏新区' },
          { value: 440304, label: '福田区' },
          { value: 440309, label: '光明新区' },
          { value: 440307, label: '龙岗区' },
          { value: 440312, label: '龙华新区' },
          { value: 440303, label: '罗湖区' },
          { value: 440305, label: '南山区' },
          { value: 440310, label: '坪山新区' },
      ...
      },
      {
        ...
        label: '中山市',
        children: [
          { value: 442022, label: '板芙镇' },
          { value: 442019, label: '大涌镇' },
          { value: 442009, label: '东凤镇' },
          { value: 442012, label: '东升镇' },
          { value: 442010, label: '阜沙镇' },
          { value: 442018, label: '港口镇' },
          { value: 442013, label: '古镇镇' },
          { value: 442014, label: '横栏镇' },
          { value: 442007, label: '黄圃镇' },
          { value: 442006, label: '火炬开发区' },
          { value: 442016, label: '民众镇' },
          { value: 442017, label: '南朗镇' },
          { value: 442004, label: '南区' },
          { value: 442008, label: '南头镇' },
          { value: 442015, label: '三角镇' },
          { value: 442021, label: '三乡镇' },
          { value: 442020, label: '沙溪镇' },
          { value: 442023, label: '神湾镇' },
          { value: 442001, label: '石岐区' },
          { value: 442024, label: '坦洲镇' },
          { value: 442005, label: '五桂山区' },
          { value: 442011, label: '小榄镇' }
        ]
      },
      {
        value: 440400,
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { value: 450227, label: '柳东新区' },
          { value: 450221, label: '柳江县' },
    ...
    children: [
      {
        ...
        label: '常州市',
        children: [
          { value: 320482, label: '金坛市' },
          { value: 320481, label: '溧阳市' },
          { value: 320405, label: '戚墅堰区' },
      ...
      },
      {
        ...
        label: '无锡市',
        children: [
          { value: 320204, label: '北塘区' },
          { value: 320211, label: '滨湖区' },
          { value: 320202, label: '崇安区' },
          { value: 320206, label: '惠山区' },
          { value: 320281, label: '江阴市' },
          { value: 320203, label: '南长区' },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: '金普新区',
        children: [
          { value: 211503, label: '保税区' },
          { value: 211501, label: '金州新区' },
          { value: 211502, label: '普湾新区' }
        ]
      },
      {
        value: 210700,
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: '西咸新区',
        children: [
          { value: 611102, label: '沣东新城' },
          { value: 611104, label: '沣西新城' },
          { value: 611105, label: '泾河新城' },
          { value: 611101, label: '空港新城' },
          { value: 611103, label: '秦汉新城' }
        ]
      },
      {
        value: 610600,
    ...
    children: [
      {
        ...
        children: [
          ...
          { value: 120223, label: '静海县' },
          { value: 120112, label: '津南区' },
          { value: 120225, label: '蓟县' },
          { value: 120104, label: '南开区' },
          { value: 120221, label: '宁河县' },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: '林芝地区',
        children: [
          { value: 542625, label: '波密县' },
          { value: 542626, label: '察隅县' },
          { value: 542622, label: '工布江达县' },
          { value: 542627, label: '朗县' },
          { value: 542621, label: '林芝县' },
          { value: 542623, label: '米林县' },
          { value: 542624, label: '墨脱县' }
        ]
      },
      {
        value: 540100,
      ...
      },
      {
        ...
        label: '山南地区',
        children: [
          { value: 542227, label: '措美县' },
          { value: 542232, label: '错那县' },
          { value: 542223, label: '贡嘎县' },
          { value: 542229, label: '加查县' },
          { value: 542233, label: '浪卡子县' },
          { value: 542231, label: '隆子县' },
          { value: 542228, label: '洛扎县' },
          { value: 542221, label: '乃东县' },
          { value: 542225, label: '琼结县' },
          { value: 542226, label: '曲松县' },
          { value: 542224, label: '桑日县' },
          { value: 542222, label: '扎囊县' }
        ]
      }
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: '哈密地区',
        children: [
          { value: 652222, label: '巴里坤哈萨克自治县' },
          { value: 652201, label: '哈密市' },
          { value: 652223, label: '伊吾县' }
        ]
      },
      {
        value: 653200,
      ...
      },
      {
        ...
        label: '吐鲁番地区',
        children: [
          { value: 652122, label: '鄯善县' },
          { value: 652101, label: '吐鲁番市' },
          { value: 652123, label: '托克逊县' }
        ]
      },
      {
        value: 650100,
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { value: 330283, label: '奉化市' },
          { value: 330203, label: '海曙区' },
          { value: 330205, label: '江北区' },
          { value: 330204, label: '江东区' },
      ...
      },
      {
        ...
        label: '舟山群岛新区',
        children: [
          { value: 331209, label: '长涂岛' },
          { value: 331205, label: '岱山岛西南部' },
          { value: 331201, label: '金塘岛' },
          { value: 331202, label: '六横岛' },
          { value: 331203, label: '衢山岛' },
          { value: 331206, label: '泗礁岛' },
          { value: 331210, label: '虾峙岛' },
          { value: 331208, label: '洋山岛' },
          { value: 331204, label: '舟山本岛西北部' },
          { value: 331207, label: '朱家尖岛' }
        ]
      }
    ]
  },
    ...
    children: [
      {
        ...
        label: '澳门半岛',
        children: [
          { value: 820103, label: '大堂区' },
          { value: 820105, label: '风顺堂区' },
          { value: 820101, label: '花地玛堂区' },
          { value: 820102, label: '圣安多尼堂区' },
          { value: 820104, label: '望德堂区' }
        ]
      },
      {
        value: 820200,
        label: '氹仔岛',
        children: [{ value: 820201, label: '嘉模堂区' }]
      },
      {
        value: 820300,
        label: '路环岛',
        children: [{ value: 820301, label: '圣方济各堂区' }]
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        label: '高雄市',
        children: [
          { value: 710223, label: '阿莲区' },
          { value: 710214, label: '大寮区' },
          { value: 710216, label: '大社区' },
          { value: 710215, label: '大树区' },
          { value: 710212, label: '凤山区' },
          { value: 710219, label: '冈山区' },
          { value: 710202, label: '鼓山区' },
          { value: 710225, label: '湖内区' },
          { value: 710233, label: '甲仙区' },
          { value: 710208, label: '苓雅区' },
          { value: 710213, label: '林园区' },
          { value: 710232, label: '六龟区' },
          { value: 710224, label: '路竹区' },
          { value: 710236, label: '茂林区' },
          { value: 710231, label: '美浓区' },
          { value: 710228, label: '弥陀区' },
          { value: 710238, label: '那玛夏区' },
          { value: 710235, label: '内门区' },
          { value: 710204, label: '楠梓区' },
          { value: 710218, label: '鸟松区' },
          { value: 710207, label: '前金区' },
          { value: 710209, label: '前镇区' },
          { value: 710220, label: '桥头区' },
          { value: 710226, label: '茄萣区' },
          { value: 710210, label: '旗津区' },
          { value: 710230, label: '旗山区' },
          { value: 710217, label: '仁武区' },
          { value: 710205, label: '三民区' },
          { value: 710234, label: '杉林区' },
          { value: 710237, label: '桃源区' },
          { value: 710222, label: '田寮区' },
          { value: 710211, label: '小港区' },
          { value: 710206, label: '新兴区' },
          { value: 710221, label: '燕巢区' },
          { value: 710201, label: '盐埕区' },
          { value: 710227, label: '永安区' },
          { value: 710229, label: '梓官区' },
          { value: 710203, label: '左营区' }
        ]
      },
      {
        value: 713500,
        label: '花莲县',
        children: [
          { value: 713527, label: '丰滨乡' },
          { value: 713521, label: '凤林镇' },
          { value: 713529, label: '富里乡' },
          { value: 713526, label: '光复乡' },
          { value: 713501, label: '花莲市' },
          { value: 713524, label: '吉安乡' },
          { value: 713528, label: '瑞穗乡' },
          { value: 713525, label: '寿丰乡' },
          { value: 713531, label: '万荣乡' },
          { value: 713523, label: '新城乡' },
          { value: 713530, label: '秀林乡' },
          { value: 713522, label: '玉里镇' },
          { value: 713532, label: '卓溪乡' }
        ]
      },
      {
        value: 713000,
        label: '嘉义县',
        children: [
          { value: 713038, label: '阿里山乡' },
          { value: 713023, label: '布袋镇' },
          { value: 713024, label: '大林镇' },
          { value: 713037, label: '大埔乡' },
          { value: 713029, label: '东石乡' },
          { value: 713036, label: '番路乡' },
          { value: 713028, label: '六脚乡' },
          { value: 713031, label: '鹿草乡' },
          { value: 713035, label: '梅山乡' },
          { value: 713025, label: '民雄乡' },
          { value: 713002, label: '朴子市' },
          { value: 713032, label: '水上乡' },
          { value: 713001, label: '太保市' },
          { value: 713026, label: '溪口乡' },
          { value: 713027, label: '新港乡' },
          { value: 713030, label: '义竹乡' },
          { value: 713033, label: '中埔乡' },
          { value: 713034, label: '竹崎乡' }
        ]
      },
      {
        value: 710700,
        label: '嘉义市',
        children: [
          { value: 710701, label: '东区' },
          { value: 710702, label: '西区' }
        ]
      },
      {
        value: 710300,
        label: '基隆市',
        children: [
          { value: 710306, label: '安乐区' },
          { value: 710303, label: '暖暖区' },
          { value: 710302, label: '七堵区' },
          { value: 710304, label: '仁爱区' },
          { value: 710307, label: '信义区' },
          { value: 710305, label: '中山区' },
          { value: 710301, label: '中正区' }
        ]
      },
      {
        value: 713700,
        label: '金门县',
        children: [
          { value: 713701, label: '金城镇' },
          { value: 713702, label: '金湖镇' },
          { value: 713704, label: '金宁乡' },
          { value: 713703, label: '金沙镇' },
          { value: 713705, label: '烈屿乡' },
          { value: 713706, label: '乌丘乡' }
        ]
      },
      {
        value: 713800,
        label: '连江县',
        children: [
          { value: 713802, label: '北竿乡' },
          { value: 713804, label: '东引乡' },
          { value: 713803, label: '莒光乡' },
          { value: 713801, label: '南竿乡' }
        ]
      },
      {
        value: 712500,
        label: '苗栗县',
        children: [
          { value: 712527, label: '大湖乡' },
          { value: 712528, label: '公馆乡' },
          { value: 712525, label: '后龙镇' },
          { value: 712501, label: '苗栗市' },
          { value: 712530, label: '南庄乡' },
          { value: 712535, label: '三湾乡' },
          { value: 712532, label: '三义乡' },
          { value: 712536, label: '狮潭乡' },
          { value: 712537, label: '泰安乡' },
          { value: 712529, label: '铜锣乡' },
          { value: 712522, label: '通霄镇' },
          { value: 712524, label: '头份镇' },
          { value: 712531, label: '头屋乡' },
          { value: 712533, label: '西湖乡' },
          { value: 712521, label: '苑里镇' },
          { value: 712534, label: '造桥乡' },
          { value: 712523, label: '竹南镇' },
          { value: 712526, label: '卓兰镇' }
        ]
      },
      {
        value: 712800,
        label: '南投县',
        children: [
          { value: 712822, label: '草屯镇' },
          { value: 712829, label: '国姓乡' },
          { value: 712824, label: '集集镇' },
          { value: 712826, label: '鹿谷乡' },
          { value: 712825, label: '名间乡' },
          { value: 712801, label: '南投市' },
          { value: 712821, label: '埔里镇' },
          { value: 712832, label: '仁爱乡' },
          { value: 712830, label: '水里乡' },
          { value: 712831, label: '信义乡' },
          { value: 712828, label: '鱼池乡' },
          { value: 712827, label: '中寮乡' },
          { value: 712823, label: '竹山镇' }
        ]
      },
      {
        value: 713600,
        label: '澎湖县',
        children: [
          { value: 713622, label: '白沙乡' },
          { value: 713621, label: '湖西乡' },
          { value: 713601, label: '马公市' },
          { value: 713625, label: '七美乡' },
          { value: 713624, label: '望安乡' },
          { value: 713623, label: '西屿乡' }
        ]
      },
      {
        value: 713300,
        label: '屏东县',
        children: [
          { value: 713325, label: '长治乡' },
          { value: 713321, label: '潮州镇' },
          { value: 713342, label: '车城乡' },
          { value: 713350, label: '春日乡' },
          { value: 713322, label: '东港镇' },
          { value: 713335, label: '枋寮乡' },
          { value: 713344, label: '枋山乡' },
          { value: 713330, label: '高树乡' },
          { value: 713323, label: '恒春镇' },
          { value: 713340, label: '佳冬乡' },
          { value: 713327, label: '九如乡' },
          { value: 713337, label: '崁顶乡' },
          { value: 713349, label: '来义乡' },
          { value: 713328, label: '里港乡' },
          { value: 713338, label: '林边乡' },
          { value: 713326, label: '麟洛乡' },
          { value: 713341, label: '琉球乡' },
          { value: 713347, label: '玛家乡' },
          { value: 713343, label: '满州乡' },
          { value: 713352, label: '牡丹乡' },
          { value: 713339, label: '南州乡' },
          { value: 713332, label: '内埔乡' },
          { value: 713301, label: '屏东市' },
          { value: 713345, label: '三地门乡' },
          { value: 713351, label: '狮子乡' },
          { value: 713348, label: '泰武乡' },
          { value: 713324, label: '万丹乡' },
          { value: 713331, label: '万峦乡' },
          { value: 713346, label: '雾台乡' },
          { value: 713334, label: '新埤乡' },
          { value: 713336, label: '新园乡' },
          { value: 713329, label: '盐埔乡' },
          { value: 713333, label: '竹田乡' }
        ]
      },
      {
        value: 710400,
        ...
        children: [
          ...
          { value: 710408, label: '北屯区' },
          { value: 710422, label: '大安区' },
          { value: 710424, label: '大肚区' },
          { value: 710411, label: '大甲区' },
          { value: 710428, label: '大里区' },
          { value: 710418, label: '大雅区' },
          { value: 710402, label: '东区' },
          { value: 710410, label: '东势区' },
          { value: 710409, label: '丰原区' },
          { value: 710429, label: '和平区' },
          { value: 710415, label: '后里区' },
          { value: 710425, label: '龙井区' },
          { value: 710403, label: '南区' },
          { value: 710407, label: '南屯区' },
          { value: 710412, label: '清水区' },
          { value: 710413, label: '沙鹿区' },
          { value: 710416, label: '神冈区' },
          { value: 710420, label: '石冈区' },
          { value: 710427, label: '太平区' },
          { value: 710417, label: '潭子区' },
          { value: 710421, label: '外埔区' },
          { value: 710426, label: '雾峰区' },
          { value: 710414, label: '梧栖区' },
          { value: 710423, label: '乌日区' },
          { value: 710419, label: '新社区' },
          { value: 710404, label: '西区' },
          { value: 710406, label: '西屯区' },
      ...
      },
      {
        ...
        label: '台南市',
        children: [
          { value: 710529, label: '安定区' },
          { value: 710506, label: '安南区' },
          { value: 710507, label: '安平区' },
          { value: 710511, label: '白河区' },
          { value: 710525, label: '北门区' },
          { value: 710504, label: '北区' },
          { value: 710519, label: '大内区' },
          { value: 710501, label: '东区' },
          { value: 710514, label: '东山区' },
          { value: 710537, label: '关庙区' },
          { value: 710518, label: '官田区' },
          { value: 710536, label: '归仁区' },
          { value: 710513, label: '后壁区' },
          { value: 710520, label: '佳里区' },
          { value: 710524, label: '将军区' },
          { value: 710517, label: '六甲区' },
          { value: 710512, label: '柳营区' },
          { value: 710538, label: '龙崎区' },
          { value: 710515, label: '麻豆区' },
          { value: 710533, label: '南化区' },
          { value: 710502, label: '南区' },
          { value: 710532, label: '楠西区' },
          { value: 710523, label: '七股区' },
          { value: 710535, label: '仁德区' },
          { value: 710527, label: '善化区' },
          { value: 710530, label: '山上区' },
          { value: 710516, label: '下营区' },
          { value: 710522, label: '西港区' },
          { value: 710526, label: '新化区' },
          { value: 710528, label: '新市区' },
          { value: 710509, label: '新营区' },
          { value: 710521, label: '学甲区' },
          { value: 710510, label: '盐水区' },
          { value: 710539, label: '永康区' },
          { value: 710531, label: '玉井区' },
          { value: 710508, label: '中西区' },
          { value: 710534, label: '左镇区' }
        ]
      },
      {
        value: 710100,
        label: '台北市',
        children: [
          { value: 710112, label: '北投区' },
          { value: 710103, label: '大安区' },
          { value: 710106, label: '大同区' },
          { value: 710110, label: '内湖区' },
          { value: 710109, label: '南港区' },
          { value: 710111, label: '士林区' },
          { value: 710101, label: '松山区' },
          { value: 710107, label: '万华区' },
          { value: 710108, label: '文山区' },
          { value: 710102, label: '信义区' },
          { value: 710104, label: '中山区' },
          { value: 710105, label: '中正区' }
        ]
      },
      {
        value: 713400,
        label: '台东县',
        children: [
          { value: 713423, label: '卑南乡' },
          { value: 713427, label: '长滨乡' },
          { value: 713421, label: '成功镇' },
          { value: 713425, label: '池上乡' },
          { value: 713434, label: '达仁乡' },
          { value: 713429, label: '大武乡' },
          { value: 713426, label: '东河乡' },
          { value: 713422, label: '关山镇' },
          { value: 713431, label: '海端乡' },
          { value: 713433, label: '金峰乡' },
          { value: 713435, label: '兰屿乡' },
          { value: 713424, label: '鹿野乡' },
          { value: 713430, label: '绿岛乡' },
          { value: 713401, label: '台东市' },
          { value: 713428, label: '太麻里乡' },
          { value: 713432, label: '延平乡' }
        ]
      },
      {
        value: 712300,
        label: '桃园县',
        children: [
          { value: 712304, label: '八德市' },
          { value: 712321, label: '大溪镇' },
          { value: 712324, label: '大园乡' },
          { value: 712331, label: '复兴乡' },
          { value: 712330, label: '观音乡' },
          { value: 712325, label: '龟山乡' },
          { value: 712327, label: '龙潭乡' },
          { value: 712306, label: '芦竹市' },
          { value: 712303, label: '平镇市' },
          { value: 712301, label: '桃园市' },
          { value: 712329, label: '新屋乡' },
          { value: 712305, label: '杨梅市' },
          { value: 712302, label: '中坜市' }
        ]
      },
      {
        value: 710800,
        label: '新北市',
        children: [
          { value: 710823, label: '八里区' },
          { value: 710801, label: '板桥区' },
          { value: 710810, label: '淡水区' },
          { value: 710826, label: '贡寮区' },
          { value: 710827, label: '金山区' },
          { value: 710817, label: '林口区' },
          { value: 710814, label: '芦洲区' },
          { value: 710820, label: '坪林区' },
          { value: 710824, label: '平溪区' },
          { value: 710812, label: '瑞芳区' },
          { value: 710809, label: '三峡区' },
          { value: 710821, label: '三芝区' },
          { value: 710802, label: '三重区' },
          { value: 710818, label: '深坑区' },
          { value: 710819, label: '石碇区' },
          { value: 710822, label: '石门区' },
          { value: 710825, label: '双溪区' },
          { value: 710807, label: '树林区' },
          { value: 710816, label: '泰山区' },
          { value: 710813, label: '土城区' },
          { value: 710828, label: '万里区' },
          { value: 710815, label: '五股区' },
          { value: 710829, label: '乌来区' },
          { value: 710806, label: '新店区' },
          { value: 710805, label: '新庄区' },
          { value: 710811, label: '汐止区' },
          { value: 710808, label: '莺歌区' },
          { value: 710804, label: '永和区' },
          { value: 710803, label: '中和区' }
        ]
      },
      {
        value: 710600,
        label: '新竹市',
        children: [
          { value: 710602, label: '北区' },
          { value: 710601, label: '东区' },
          { value: 710603, label: '香山区' }
        ]
      },
      {
        value: 712400,
        label: '新竹县',
        children: [
          { value: 712429, label: '宝山乡' },
          { value: 712428, label: '北埔乡' },
          { value: 712430, label: '峨眉乡' },
          { value: 712423, label: '关西镇' },
          { value: 712427, label: '横山乡' },
          { value: 712424, label: '湖口乡' },
          { value: 712431, label: '尖石乡' },
          { value: 712432, label: '五峰乡' },
          { value: 712425, label: '新丰乡' },
          { value: 712422, label: '新埔镇' },
          { value: 712426, label: '芎林乡' },
          { value: 712401, label: '竹北市' },
          { value: 712421, label: '竹东镇' }
        ]
      },
      {
        value: 712200,
        label: '宜兰县',
        children: [
          { value: 712230, label: '大同乡' },
          { value: 712227, label: '冬山乡' },
          { value: 712224, label: '礁溪乡' },
          { value: 712221, label: '罗东镇' },
          { value: 712231, label: '南澳乡' },
          { value: 712229, label: '三星乡' },
          { value: 712222, label: '苏澳镇' },
          { value: 712223, label: '头城镇' },
          { value: 712228, label: '五结乡' },
          { value: 712201, label: '宜兰市' },
          { value: 712226, label: '员山乡' },
          { value: 712225, label: '壮围乡' }
        ]
      },
      {
        value: 712900,
        label: '云林县',
        children: [
          { value: 712934, label: '褒忠乡' },
          { value: 712925, label: '北港镇' },
          { value: 712928, label: '莿桐乡' },
          { value: 712927, label: '大埤乡' },
          { value: 712933, label: '东势乡' },
          { value: 712901, label: '斗六市' },
          { value: 712921, label: '斗南镇' },
          { value: 712930, label: '二仑乡' },
          { value: 712926, label: '古坑乡' },
          { value: 712922, label: '虎尾镇' },
          { value: 712938, label: '口湖乡' },
          { value: 712929, label: '林内乡' },
          { value: 712931, label: '仑背乡' },
          { value: 712932, label: '麦寮乡' },
          { value: 712939, label: '水林乡' },
          { value: 712937, label: '四湖乡' },
          { value: 712935, label: '台西乡' },
          { value: 712924, label: '土库镇' },
          { value: 712923, label: '西螺镇' },
          { value: 712936, label: '元长乡' }
        ]
      },
      {
        value: 712700,
        label: '彰化县',
        children: [
          { value: 712738, label: '北斗镇' },
          { value: 712743, label: '大城乡' },
          { value: 712732, label: '大村乡' },
          { value: 712739, label: '二林镇' },
          { value: 712737, label: '二水乡' },
          { value: 712742, label: '芳苑乡' },
          { value: 712728, label: '芬园乡' },
          { value: 712725, label: '福兴乡' },
          { value: 712722, label: '和美镇' },
          { value: 712727, label: '花坛乡' },
          { value: 712721, label: '鹿港镇' },
          { value: 712741, label: '埤头乡' },
          { value: 712734, label: '埔心乡' },
          { value: 712733, label: '埔盐乡' },
          { value: 712724, label: '伸港乡' },
          { value: 712736, label: '社头乡' },
          { value: 712740, label: '田尾乡' },
          { value: 712731, label: '田中镇' },
          { value: 712723, label: '线西乡' },
          { value: 712730, label: '溪湖镇' },
          { value: 712726, label: '秀水乡' },
          { value: 712745, label: '溪州乡' },
          { value: 712735, label: '永靖乡' },
          { value: 712729, label: '员林镇' },
          { value: 712701, label: '彰化市' },
          { value: 712744, label: '竹塘乡' }
        ]
      }
    ]
  },
    ...
    children: [
      {
        ...
        children: [
          ...
          { value: 810203, label: '九龙城区' },
          { value: 810202, label: '深水埗区' },
          { value: 810204, label: '黄大仙区' },
          { value: 810201, label: '油尖旺区' }
        ]
      },
      {
        value: 810300,
        label: '新界',
        children: [
          { value: 810304, label: '北区' },
          { value: 810308, label: '葵青区' },
          { value: 810309, label: '离岛区' },
          { value: 810306, label: '西贡区' },
          { value: 810307, label: '沙田区' },
          { value: 810305, label: '大埔区' },
          { value: 810301, label: '荃湾区' },
          { value: 810302, label: '屯门区' },
          { value: 810303, label: '元朗区' }
        ]
      },
      {
        value: 810100,
